...
namespace Osborne_Assignment3.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Hyperlink,Genre,Poster,Year")] Movie movie, IFormFile Poster)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Hyperlink,Genre,Poster,Year")] Movie movie)
        {
            if (id != movie.Id)
            {
                return NotFound();
